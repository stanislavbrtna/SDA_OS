...
#define ASCR_SETTINGS_BTN                             (uint8_t*)"Settings"
...
#define SD_UMOUNT                                     (uint8_t*)"Unmount SD card"
...
#define SCR_RESET_KEY                                 (uint8_t*)"Reset keys"
...
#define SCR_KEY_UNLOCK_COUNT                          (uint8_t *)"failed unlocks."
#define SCR_SECU_CLEAR                                (uint8_t *)"Clear"
#define SCR_SECU_PIN_UNLOCK                           (uint8_t *)"Unlock with PIN"
#define SCR_SECU_SET_DISTRESS                         (uint8_t *)"Set distress"
#define SCR_SECU_SET_PIN                              (uint8_t *)"Set pin"
#define SCR_SECU_PIN_SETUP                            (uint8_t *)"Pin setup:"
